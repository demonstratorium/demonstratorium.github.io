...
const _ = {
  ...
  , X : {
          ...
          , alx : (A,e,f=1,g=1)=>(T,E)=>{T[_.X.U(A,E)]=(T[_.X.U(A,E)]||0)+(E[f]??1)*(E[g]??1);return T}
          ...
          , grpsum : (d,e) =>_.X.OE(e.f.reduce(_.X.fc,d).reduce(_.X.alx(e.s,{},e.c),{})).map(_.X.KV)
          , search : (d,e) =>e.v.split(' ').reduce(_.X.mfms(e.c),e.f.reduce(_.X.fc,d).map(_.X.as(e.s)))
          , kreuz : (d,e) => { const RKEY = e.s.join(',')||'DIM1,DIM2' // Dimensions Werte des doppelFilters werden als globale Filter "verarbeitet"
  ...
  , U : {
          ...
          , Dj2j : d  => _.X.OE(d).reduce((T,E)=>{T[E[0]]=E[1]['S'];return T},{})
